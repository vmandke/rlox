            ...
            match c {
                ...
                '/' => {
                    match p {
                        ...
                        _ => {
                            ...
                            current_lexeme.clear();
                            add_boundary_token(
                                TokenType::BoundaryTokens(BoundaryTokens::Slash),
                                &c.to_string(),
                                &mut tokens,
                                line,
                                col,
                ...
                '.' => {
                    ...
                    if !current_lexeme.is_empty()
                        && current_lexeme.chars().all(|c| c.is_ascii_digit())
                    {
                        ...
                        current_lexeme.clear();
                        add_boundary_token(
                            TokenType::BoundaryTokens(BoundaryTokens::Dot),
                            &c.to_string(),
                            &mut tokens,
                            line,
                            col,
